                        ...
                        <tr class="bb-row">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    @else
                                        <!-- ✅ Icono alineado (ya no se ve “arriba”) -->
                            ...
                            <td class="px-4 py-3 whitespace-nowrap align-middle">
                                <div class="flex justify-end">
                                    <div class="inline-flex items-center" style="gap:6px;">
                                        ...
                                        class="bb-action inline-flex items-center justify-center"
                                        style="width:27px !important; height:32px !important; padding:0 !important; margin:0 !important; line-height:0 !important;"
                                        title="Ver">
                                            <svg class="w-4 h-4 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        class="bb-action bb-action-edit inline-flex items-center justify-center"
                                        style="width:27px !important; height:32px !important; padding:0 !important; margin:0 !important; line-height:0 !important;"
                                        title="Editar">
                                            <svg class="w-4 h-4 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <!-- Eliminar -->
                                        <form class="inline-flex m-0 p-0"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                    class="bb-action bb-action-del inline-flex items-center justify-center"
                                                    style="width:27px !important; height:32px !important; padding:0 !important; margin:0 !important; line-height:0 !important;"
                                                    title="Eliminar">
                                                <svg class="w-4 h-4 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <td colspan="5" class="px-4 py-10 text-center">
                                <div class="text-gray-500 dark:text-gray-300">
                                    <div class="mx-auto bb-icon-pill" style="width:56px;height:56px;border-radius:18px;">
                                        <svg class="w-5 h-5 bb-gold block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  d="M14.121 14.121L19 19M5 5l4.879 4.879M15 7a3 3 0 11-6 0 3 3 0 016 0zm0 10a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                    </div>
