<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.servicios.create') }}?modal=1" class="bb-btn-gold">
                        ...
                        <tr class="bb-row">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    <!-- Ver -->
                                    <a href="{{ route('admin.servicios.show', $servicio->id_servicio ?? $servicio->id) }}?modal=1"
                                    ...
                                    <!-- Editar -->
                                    <a href="{{ route('admin.servicios.edit', $servicio->id_servicio ?? $servicio->id) }}?modal=1"
                                    ...
                                    <!-- Eliminar -->
                                    <form action="{{ route('admin.servicios.destroy', $servicio->id_servicio ?? $servicio->id) }}"
                                          method="POST"
