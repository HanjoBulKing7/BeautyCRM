...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
    ...
    <div class="flex items-center gap-2">
      <a
        href="{{ route('admin.empleados.create', ['modal' => 1]) }}"
        data-bb-modal="1"
        data-bb-title="Nuevo Empleado"
        data-bb-url="{{ route('admin.empleados.create', ['modal' => 1]) }}"
        class="bb-btn-gold"
      >
              ...
              <tr class="bb-row">
                ...
                <td class="px-4 py-3 whitespace-nowrap">
                  <div class="flex items-center justify-end gap-2">
                    ...
                    <!-- Editar -->
                    <a
                      href="{{ route('admin.empleados.edit', [$empleado->id, 'modal' => 1]) }}"
                      data-bb-modal="1"
                      data-bb-title="Editar Empleado"
                      data-bb-url="{{ route('admin.empleados.edit', [$empleado->id, 'modal' => 1]) }}"
