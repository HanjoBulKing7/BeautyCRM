<style>
  ...
  /* ✅ ACCIONES: Íconos rectos, centrados, mismo tamaño */
  .bb-action{
    width: 40px;
    height: 40px;
    border-radius: 14px;
  ...
  /* ✅ evita “brincos” por el form dentro de flex */
  .bb-action-form{ margin:0 !important; }
</style>
...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
    ...
    <div class="flex items-center gap-2">
      <a href="{{ route('admin.empleados.create') }}"
        ...
        data-bb-url="{{ route('admin.empleados.create') }}"
        class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-[rgba(201,162,74,.22)]
               bg-white/70 hover:bg-white shadow-sm hover:shadow transition text-gray-800 font-semibold">
          ...
          <tbody>
            @forelse($empleados as $empleado)
              <tr class="bb-row">
                ...
                <td class="px-4 py-3 whitespace-nowrap align-middle" style="width:160px;">
                  <div class="flex items-center justify-end gap-2">

                    <!-- Editar -->
                    <a
                        href="{{ route('admin.empleados.edit', $empleado->id) }}"
                        data-bb-modal="1"
                        data-bb-open="modal"
                        data-bb-title="Editar Empleado"
                        data-bb-url="{{ route('admin.empleados.edit', ['empleado' => $empleado->id, 'modal' => 1]) }}"
  ...
  <!-- ✅ MÓVIL: CARDS -->
  <!-- ===================== -->
  <div class="empleados-cards space-y-3">
    @forelse($empleados as $empleado)
        ...
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            ...
            <div class="text-xs text-gray-600 dark:text-gray-400 mt-2 space-y-1">
              <div class="flex items-center gap-2">
                <i class="fas fa-envelope text-[11px] text-gray-400 w-4 text-center"></i>
                <span class="truncate">{{ $empleado->email ?? '—' }}</span>
              </div>
              <div class="flex items-center gap-2">
                <i class="fas fa-phone text-[11px] text-gray-400 w-4 text-center"></i>
