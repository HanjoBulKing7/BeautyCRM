@extends('layouts.app')
@section('title','Editar Categoría - Salón de Belleza')
    ...
    >
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm">Actualice la información de {{ $categoria->nombre }}</p>
            </div>
        </div>
    </div>

    <div class="p-6">
        <form method="POST" action="{{ route('admin.categoriaservicios.update', $categoria->id_categoria) }}" enctype="multipart/form-data" class="space-y-6">
            @method('PUT')
            @csrf
