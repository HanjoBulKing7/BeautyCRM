        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-calendar-plus"></i> Nueva Cita</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.citas.store') }}" method="POST">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="fecha_cita" id="fecha_cita" class="form-control" 
                                           value="{{ old('fecha_cita') }}" required min="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="estado_cita" id="estado_cita" class="form-select" required>
                                ...
                                <option value="cancelada" {{ old('estado_cita') == 'cancelada' ? 'selected' : '' }}>Cancelada</option>
