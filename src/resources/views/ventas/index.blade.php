...
<div class="bg-white border border-gray-200 shadow-md rounded-xl p-6 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-3 md:gap-0">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <i class="fas fa-cash-register mr-3 text-red-500 dark:text-red-400"></i>
            Ventas
        </h3>       
        <div class="flex flex-col md:flex-row items-center gap-3">
            ...
            <form method="GET" action="{{ route('ventas.index') }}" class="flex items-center gap-2">
                <input 
                    ...
                    class="border border-gray-300 rounded-lg p-2 text-sm focus:ring-blue-500 focus:border-blue-500 cursor-pointer dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-400 dark:focus:border-blue-400"
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-3 py-2 md:px-4 md:py-3 border dark:border-gray-600">
                            <div class="flex space-x-1 md:space-x-2">
                              ...
                              <!--   <a href="{{ route('ventas.show', $venta) }}" class="text-blue-500 hover:text-blue-700 p-1 dark:text-blue-400 dark:hover:text-blue-300" title="Ver">
                            ...
                            <div class="mt-1 text-xs text-gray-600 md:hidden dark:text-gray-400">
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('ventas.ticket', $venta) }}" 
                                       class="inline-flex items-center text-purple-600 hover:text-purple-800 text-xs dark:text-purple-400 dark:hover:text-purple-300"
                                       target="_blank">
